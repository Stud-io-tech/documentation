...
| RF04 | Gerenciar Produto | <p>O sistema deve permitir que os usuários gerenciem produtos da sua própria loja virtual.</p><p>**Dados de produto:** id\_produto, nome,  descricao, imagem, preco, quantidade, id\_loja, ativo,  data\_criado e data\_atualizado.</p> | Alta       | RF03        |

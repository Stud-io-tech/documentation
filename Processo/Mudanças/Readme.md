...
## Linhas
- **Branchs das issues**: Se trata da linha de cada issue (feature) a ser implementada, ao concluir a demanda deve-se fazer um Pull Request solicitando o merge para a branch dev, após isso, o código será testado pelo analista de qualidade ou profissional responsável (caixa branca e caixa preta);
